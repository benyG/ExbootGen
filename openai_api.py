...
_WORLD_PATCH = {"type": "array", "items": _WP_ITEM}
...
_TERMINAL_TOPLEVEL_VALIDATOR = {
    "type": "object",
    "additionalProperties": False,
    "required": ["kind", "path", "equals", "expr", "message"],
    "properties": {
        "kind": {"type": "string"},
        "path": {"anyOf": [{"type": "string"}, {"type": "null"}]},
        "equals": {"anyOf": [{"type": "string"}, {"type": "number"}, {"type": "boolean"}, {"type": "null"}]},
        "expr": {"anyOf": [{"type": "string"}, {"type": "null"}]},
        "message": {"anyOf": [{"type": "string"}, {"type": "null"}]},
    },
}

_TERMINAL_INNER_VALIDATOR = {
    "type": "object",
    "additionalProperties": False,
    "required": ["kind", "match", "response"],
    "properties": {
        "kind": {"type": "string"},
        "match": {
            "type": "object",
            "additionalProperties": False,
            "required": ["program", "subcommand", "flags", "args"],
            "properties": {
                "program": {"type": "string"},
        ...
        "response": {
            "type": "object",
            "additionalProperties": False,
            "required": ["stdout_template", "world_patch"],
            "properties": {
                "stdout_template": {"type": "string"},
                "world_patch": _WORLD_PATCH,
            },
        },
    },
}
...
_TERMINAL_STEP = {
    ...
    "required": ["id", "type", "title", "instructions_md", "points", "hints",
                 "transitions", "validators", "world_patch", "terminal"],
    "properties": {
        "id": {"type": "string"},
        ...
        "validators": {"type": "array", "items": _TERMINAL_TOPLEVEL_VALIDATOR},
        "world_patch": _WORLD_PATCH,
        "terminal": {
            "type": "object",
            "additionalProperties": False,
            "required": ["prompt", "environment", "history", "validators"],
            "properties": {
                "prompt": {"type": "string"},
                "environment": {"type": "string"},
                "history": {"type": "array", "items": {"type": "string"}},
                "validators": {"type": "array", "items": _TERMINAL_INNER_VALIDATOR},
            },
        },
    },
}
...
_CONSOLE_FORM_VALIDATOR = {
    "type": "object",
    "additionalProperties": False,
    "required": ["kind", "path", "equals", "expect", "expr", "message"],
    "properties": {
        "kind": {"type": "string"},
        "path": {"anyOf": [{"type": "string"}, {"type": "null"}]},
        "equals": {"anyOf": [{"type": "string"}, {"type": "number"}, {"type": "boolean"}, {"type": "null"}]},
...
_CONSOLE_FORM_FIELD = {
    "type": "object",
    "additionalProperties": False,
    "required": ["id", "label", "widget", "options", "required", "placeholder", "helptext"],
    "properties": {
        "id": {"type": "string"},
        "label": {"type": "string"},
        "widget": {"type": "string"},
        ...
        "helptext": {"anyOf": [{"type": "string"}, {"type": "null"}]},
    },
}
...
_CONSOLE_FORM_STEP = {
    ...
    "additionalProperties": False,
    "required": ["id", "type", "title", "instructions_md", "points", "hints",
                 "transitions", "validators", "world_patch", "form"],
    "properties": {
        "id": {"type": "string"},
        ...
        "hints": {"type": "array", "items": {"type": "string"}},
        "transitions": _TRANSITIONS,
        "validators": {"type": "array", "items": _CONSOLE_FORM_VALIDATOR},
        "world_patch": _WORLD_PATCH,
        "form": {
            "type": "object",
            "additionalProperties": False,
            ...
            "properties": {
                ...
                "schema": {
                    ...
                    "required": ["fields"],
                    "properties": {
                        "fields": {"type": "array", "items": _CONSOLE_FORM_FIELD},
                    },
                },
            },
        },
...
_INSPECT_VALIDATOR = {
    "type": "object",
    "additionalProperties": False,
    "required": ["kind", "jsonpath", "equals", "expr", "message"],
    "properties": {
        "kind": {"type": "string"},
        "jsonpath": {"anyOf": [{"type": "string"}, {"type": "null"}]},
        "equals": {"anyOf": [{"type": "string"}, {"type": "number"}, {"type": "boolean"}, {"type": "null"}]},
        "expr": {"anyOf": [{"type": "string"}, {"type": "null"}]},
        "message": {"anyOf": [{"type": "string"}, {"type": "null"}]},
    },
...
_INSPECT_FILE_STEP = {
    ...
    "additionalProperties": False,
    "required": ["id", "type", "title", "instructions_md", "points", "hints",
                 "transitions", "validators", "world_patch", "file_ref", "input"],
    "properties": {
        "id": {"type": "string"},
        ...
        "hints": {"type": "array", "items": {"type": "string"}},
        "transitions": _TRANSITIONS,
        "validators": {"type": "array", "items": _INSPECT_VALIDATOR},
        "world_patch": _WORLD_PATCH,
...
_ARCH_VALIDATOR = {
    ...
    "properties": {
        "kind": {"type": "string"},
        "path": {"anyOf": [{"type": "string"}, {"type": "null"}]},
        "equals": {"anyOf": [{"type": "integer"}, {"type": "string"}, {"type": "null"}]},
        "expr": {"anyOf": [{"type": "string"}, {"type": "null"}]},
        "message": {"anyOf": [{"type": "string"}, {"type": "null"}]},
    },
}
...
_PALETTE_ITEM = {
    "type": "object",
    "additionalProperties": False,
    "required": ["id", "label", "icon", "is_decoy"],
    "properties": {
        "id": {"type": "string"},
        "label": {"type": "string"},
        "icon": {"type": "string"},
...
_ARCH_NODE = {
    "type": "object",
    "additionalProperties": False,
    "required": ["id", "palette_id", "x", "y", "label"],
    "properties": {
        "id": {"type": "string"},
...
_ARCHITECTURE_STEP = {
    ...
    "additionalProperties": False,
    "required": ["id", "type", "title", "instructions_md", "points", "hints",
                 "transitions", "validators", "world_patch", "architecture"],
    "properties": {
        "id": {"type": "string"},
        ...
        "hints": {"type": "array", "items": {"type": "string"}},
        "transitions": _TRANSITIONS,
        "validators": {"type": "array", "items": _ARCH_VALIDATOR},
        "world_patch": _WORLD_PATCH,
        "architecture": {
            "type": "object",
            "additionalProperties": False,
            "required": ["mode", "palette", "initial_nodes", "world_path", "help", "expected_world"],
            "properties": {
                "mode": {"type": "string"},
                "palette": {"type": "array", "items": _PALETTE_ITEM},
                "initial_nodes": {"type": "array", "items": _ARCH_NODE},
                "world_path": {"type": "string"},
                "help": {"anyOf": [{"type": "string"}, {"type": "null"}]},
                "expected_world": {
                    "type": "object",
                    "additionalProperties": False,
                    "required": ["allow_extra_nodes", "nodes", "links"],
                    "properties": {
                        "allow_extra_nodes": {"type": "boolean"},
                        "nodes": {"type": "array", "items": _ARCH_EXPECTED_NODE},
                        "links": {"type": "array", "items": _ARCH_EXPECTED_LINK},
                    },
                },
            },
        },
...
def _quiz_step(type_const):
    return {
        ...
        "properties": {
            ...
            "hints": {"type": "array", "items": {"type": "string"}},
            "transitions": _TRANSITIONS,
            "validators": {"type": "array", "items": _QUIZ_VALIDATOR},
            "world_patch": _WORLD_PATCH,
            "question_md": {"type": "string"},
            "choices": {"type": "array", "items": _QUIZ_CHOICE},
...
_FREE_INPUT_VALIDATOR = {
    "type": "object",
    "additionalProperties": False,
    "required": ["kind", "expect", "case_sensitive", "min", "max", "pattern", "flags", "message"],
    "properties": {
        "kind": {"type": "string"},
...
_FREE_INPUT_STEP = {
    ...
    "additionalProperties": False,
    "required": ["id", "type", "title", "instructions_md", "points", "hints",
                 "transitions", "validators", "world_patch", "input"],
    "properties": {
        "id": {"type": "string"},
        ...
        "hints": {"type": "array", "items": {"type": "string"}},
        "transitions": _TRANSITIONS,
        "validators": {"type": "array", "items": _FREE_INPUT_VALIDATOR},
        "world_patch": _WORLD_PATCH,
        "input": {
            "type": "object",
            "additionalProperties": False,
            "required": ["label", "placeholder", "input_type", "unit"],
            "properties": {
                "label": {"type": "string"},
                "placeholder": {"anyOf": [{"type": "string"}, {"type": "null"}]},
                "input_type": {"anyOf": [{"type": "string"}, {"type": "null"}]},
            ...
            "properties": {
                ...
                "assets": {
                    ...
                    "items": {
                        "type": "object",
                        "additionalProperties": False,
                        "required": ["id", "kind", "filename", "mime", "inline", "content_b64", "description"],
                        "properties": {
                            "id": {"type": "string"},
                            "kind": {"type": "string"},
    ...
    for q in questions:
        ...
        if nature == 5:
            prompt = (
                ...
                f"This is a drag-and-drop question. The images may contain the items to pair or arrange.\n\n"
                f"This question may appear in ONE of three formats — detect which applies:\n\n"
                f"FORMAT A — Sequencing / Build-order:\n"
                f"  A panel of items on the LEFT must be dragged into an Answer Area on the RIGHT\n"
                f"  in the correct ORDER (e.g. code segments, pipeline steps, config lines).\n"
                f"  → value = the item text (code segment, step description, etc.)\n"
                f"  → target = a step label such as 'STEP 1', 'STEP 2', 'STEP 3' (or equivalent logical labels)\n"
                f"  Use your knowledge of {cert_name} ({provider_name}) to determine the correct order.\n\n"
                f"FORMAT B — Category mapping:\n"
                f"  Items must be dragged to matching categories or slots (not ordered).\n"
                f"  → value = the draggable item (left-side element)\n"
                f"  → target = the drop zone / category it belongs to (right-side element)\n\n"
                f"FORMAT C — Label + combobox answer area:\n"
                f"  Rows are labels on the left (e.g. threats, requirements), each with a dropdown of options.\n"
                f"  → value = an option from the dropdown choices\n"
                f"  → target = the row label (left-side label)\n"
                f"  Build candidate pairs per label. Mark the correct pair(s) with isok=1 and wrong alternatives with isok=0.\n\n"
                f"RULES FOR BOTH FORMATS:\n"
                f"- Return complete value/target pairs needed to represent the answer area.\n"
                f"- For pure sequencing/category mapping without intruders: isok=1 for all returned pairs.\n"
                f"- If intruder options exist, keep intruders with isok=0 and valid pairs with isok=1.\n\n"
                f"Return JSON only:\n"
                f'{{"question_id": <int>, "answers": [{{"value": "...", "target": "...", "isok": 0_or_1}}, ...]}}\n\n'
                f"Question ID: {q['id']}\n"
            ...
            prompt = (
                ...
                f"This question may appear in ONE of three formats — detect which one applies:\n\n"
                ...
                f"FORMAT C — Label + combobox answer area:\n"
                f"  Rows are labels on the left and each row has the same dropdown options.\n"
                f"  → value = dropdown option\n"
                f"  → target = row label\n"
                f"  Return pair candidates per label. Correct pair(s) must have isok=1; incorrect options for the same label must have isok=0.\n\n"
                f"RULES:\n"
                f"- Return complete value/target pairs needed for the represented format.\n"
                f"- For classical matching without intruders, pairs can all be isok=1.\n"
                f"- For combobox-style rows, include wrong alternatives as isok=0 when visible/derivable.\n\n"
                f"Return JSON only:\n"
                f'{{"question_id": <int>, "answers": [{{"value": "...", "target": "...", "isok": 0_or_1}}, ...]}}\n\n'
                f"Question ID: {q['id']}\n"
                f"Question text: {clean_text}\n"
            ...
            prompt = (
                f"You are completing exam questions for the {cert_name} certification from {provider_name}.\n"
                f"The images attached contain the answer area for this question.\n"
                f"If the image shows draggable/sequencing/matching/combobox answer areas, treat it as drag-and-drop style even if metadata type differs.\n"
                f"- For sequencing: use target labels like 'STEP 1', 'STEP 2', ... (or equivalent logical labels).\n"
                f"- For combobox rows: value=dropdown option, target=row label, with isok=1 for correct and isok=0 for wrong alternatives.\n"
                f"- For classic QCM choices: value=choice text, target=null, isok according to correctness.\n\n"
                f"Return JSON only:\n"
...
JSON:"""
            ...
            prompt = (
                ...
                f"This question may appear in ONE of three formats — detect which applies:\n\n"
                f"FORMAT A — Sequencing / Build-order:\n"
                f"  Items (e.g. code segments, pipeline steps, config lines) must be placed\n"
                f"  into an Answer Area in the correct ORDER.\n"
                f"  → value = the item text\n"
                f"  → target = step labels such as 'STEP 1', 'STEP 2', ...\n"
                f"  Use your knowledge of {cert_name} ({provider_name}) to determine the correct order.\n\n"
                f"FORMAT B — Category mapping:\n"
                f"  Items must be dragged to matching categories or slots (not ordered).\n"
                f"  → value = the draggable item (left-side element)\n"
                f"  → target = the drop zone / category it belongs to (right-side element)\n\n"
                f"FORMAT C — Label + combobox answer area:\n"
                f"  Left-side labels with dropdown options.\n"
                f"  → value = dropdown option\n"
                f"  → target = row label\n"
                f"  Mark correct pair(s) with isok=1 and incorrect alternatives with isok=0.\n\n"
                f"RULES FOR BOTH FORMATS:\n"
                f"- Return complete value/target pairs.\n"
                f"- Without intruders, use isok=1 for all valid pairs.\n"
                f"- If intruders/wrong alternatives exist, set those to isok=0.\n\n"
                f"Return JSON only:\n"
                f'{{"question_id": <int>, "answers": [{{"value": "...", "target": "...", "isok": 0_or_1}}, ...]}}\n\n'
                f"Question ID: {q['id']}\n"
            ...
            prompt = (
                ...
                f"  → target = right-side element it maps to (e.g. description, category, protocol)\n\n"
                f"FORMAT C — Label + combobox answer area:\n"
                f"  Rows are labels and dropdown options are candidate remediations/actions.\n"
                f"  → value = dropdown option\n"
                f"  → target = row label\n"
                f"  Return correct pair(s) as isok=1 and incorrect alternatives as isok=0.\n\n"
                f"RULES:\n"
                f"- Return complete value/target pairs.\n"
                f"- For pure matching without intruders, pairs can all be isok=1.\n"
                f"- For combobox-style options, wrong alternatives should be isok=0.\n\n"
                f"Return JSON only:\n"
                f'{{"question_id": <int>, "answers": [{{"value": "...", "target": "...", "isok": 0_or_1}}, ...]}}\n\n'
                f"Question ID: {q['id']}\n"
                f"Question text: {q['text']}\n"
