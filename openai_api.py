    ...
    for q in questions:
        ...
        if nature == 5:
            prompt = (
                ...
                f"This question may appear in ONE of two formats — detect which applies:\n\n"
                ...
                f"  → target = its position in the sequence as a number string: '1', '2', '3', …\n"
                ...
                f"- Return the COMPLETE set of pairs needed to fully answer the question.\n\n"
                f"Return JSON only:\n"
