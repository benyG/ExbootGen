...
class RedisSettings:
    ...
    def _url(self) -> str:
        return f"redis://{self._auth()}{self.host}/0"
...
CONFIG = AppConfig(
    ...
    redis=RedisSettings(
        # Vérifiez attentivement cette valeur dans la console Redis Cloud :
        # le segment numérique (ici "25453") varie selon votre instance. Une
        # simple faute de frappe entraîne les messages « getaddrinfo failed ».
        host=os.getenv(
            "REDIS_HOST",
            "redis-15453.crce197.us-east-2-1.ec2.redns.redis-cloud.com:15453",
        ),
